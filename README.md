...
Este repositório está no marco **M0: fundação**. Há somente contratos, tipos de domínio e uma CLI mínima compilável. Scanner, parsers, índices, embeddings, LLM, MCP e frontend ainda não estão implementados.
